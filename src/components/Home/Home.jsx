              ...
              <div className="landing">
                      <div className="landing-content animate__animated animate__bounce">
                        ...
                        <h2 className="lg-heading">
                          <span className="text-primary ">Ahsan Chaudhry</span>
                        </h2>
                        <div className="i-title">
                            ...
                            <p style={{marginTop : "30px" , color :"#5b83f1"}}>
                                ...
                                specializing <br className="d-none d-md-block"/> in creating stylish, modern websites, web services in cheap rates.
                            </p>
                      </div>
                    </div>
                    </div>
